...
declare module '$env/static/private' {
	...
	export const CUDA_PATH_V11_4: string;
	...
	export const NVCUDASAMPLES11_4_ROOT: string;
	...
	export const Qt5_DIR: string;
	export const QT_QPA_PLATFORM_PLUGIN_PATH: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		PyCharm: string;
		Qt5_DIR: string;
		QT_QPA_PLATFORM_PLUGIN_PATH: string;
		RlsSvcPort: string;
		SESSIONNAME: string;
		SystemDrive: string;
		SystemRoot: string;
